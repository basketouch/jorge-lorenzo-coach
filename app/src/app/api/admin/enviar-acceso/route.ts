...
export async function POST(req: NextRequest) {
  ...
  const html = buildHtml(nombreMostrado, enlace);
...
function buildHtml(nombre: string, enlace: string): string {
    ...
    <tr><td align="center" style="padding:48px 24px;">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
        ...
        <tr><td style="background:#141414;border:1px solid #2a2a2a;border-radius:16px;padding:40px;">
          ...
          <p style="margin:0 0 16px;font-size:15px;color:#aaa;line-height:1.7;">
            Ya tienes acceso a <strong style="color:#fff;">El Laboratorio del Entrenador</strong>.
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin:8px 0 24px;">
            <tr><td align="center">
              <a href="${enlace}"
                style="display:inline-block;background:#c9a84c;color:#0a0a0a;font-size:15px;font-weight:700;text-decoration:none;padding:14px 32px;border-radius:8px;">
